...
namespace Maispace\MaiFaq\Indexer;
...
class FaqIndexer extends AbstractIndexer implements SearchResultFormatterInterface
{
    private const TABLE_NAME = 'tx_maifaq_faq';
    ...
    protected function buildContent(object $record): string
    {
        ...
        return strip_tags($record->getAnswer());
    }
